...
public class MyMonthDisplayHelper {
    // display pref
    private final int mWeekStartDay;

    // holds current month, year, helps compute display
    private Calendar mCalendar;
    static TimeZone timeZone = TimeZone.getTimeZone("Asia/Bangkok");
     ...
     */
    public MyMonthDisplayHelper(int year, int month, int weekStartDay) {
        ...
        mCalendar = MyMonthDisplayHelper.getCalendar();
    ...
    public MyMonthDisplayHelper(int year, int month) {
    ...
    public static void setTimeZone(TimeZone timeZone) {
        MyMonthDisplayHelper.timeZone = timeZone;
    }
